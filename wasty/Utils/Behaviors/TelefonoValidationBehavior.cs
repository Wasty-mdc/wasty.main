...
{
    public class TelefonoValidationBehavior : Behavior<TextBox>
    {
        private static readonly Regex _telefonoRegex = new(@"^\d{9}$");
        ...
        private void Validate(object sender, RoutedEventArgs e)
        {
            ...
            bool isValid = _telefonoRegex.IsMatch(text);
